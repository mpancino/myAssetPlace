          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
              ...
              <TabsContent value="overview" className="space-y-4 pt-4">
                ...
                {selectedClass?.name?.toLowerCase() === "real estate" {selectedClass?.name?.toLowerCase() === "real estate" && asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && !isEditing && ({selectedClass?.name?.toLowerCase() === "real estate" && asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && !isEditing && ( (asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false) {selectedClass?.name?.toLowerCase() === "real estate" && asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && !isEditing && ({selectedClass?.name?.toLowerCase() === "real estate" && asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && !isEditing && ( !isEditing {selectedClass?.name?.toLowerCase() === "real estate" && asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && !isEditing && ({selectedClass?.name?.toLowerCase() === "real estate" && asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && !isEditing && ( (
                    ...
                    <Card className="col-span-1 bg-gradient-to-br from-primary/5 to-primary/10">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          {(asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false) {asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && asset?.mortgageInterestRate && asset?.mortgageAmount && ({asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && asset?.mortgageInterestRate && asset?.mortgageAmount && ( asset?.mortgageInterestRate {asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && asset?.mortgageInterestRate && asset?.mortgageAmount && ({asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && asset?.mortgageInterestRate && asset?.mortgageAmount && ( asset?.mortgageAmount {asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && asset?.mortgageInterestRate && asset?.mortgageAmount && ({asset ? isLegacyMortgageProperty(asLegacyAsset(asset)) : false && asset?.mortgageInterestRate && asset?.mortgageAmount && ( (
                            <div>
